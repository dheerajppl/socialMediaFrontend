...
const Post = ({ post }) => {
    ...
    const commentHandler = async () => {
        ...
        //      try {
        //     const res = await axios.post(`http://localhost:5097/api/post/${post._id}/comment`, { text }, {
        //         headers: {
    ...
    const deletePostHandler = async () => {
        reqDeletePost(post?._id)
        // try {
        //     const res = await axios.delete(`http://localhost:5097/api/post/delete/${post?._id}`, { withCredentials: true })
        //     if (res.data.success) {
        //         const updatedPostData = posts.filter((postItem) => postItem?._id !== post?._id);
        //         dispatch(setPosts(updatedPostData));
        //         toast.success(res.data.message);
